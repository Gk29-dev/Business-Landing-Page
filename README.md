...
- In this project, I build Business Landing Page.

- I learned, How to use icons in form input.

- I learned, border property on navbar button.

- I learned, about flex-box and how we can used to make footer section.

- I learned, flex-grow property of flexbox.

- I learned, grid property and how to use them to make team member section


***

### Checkout the webiste : [Click Here](https://the-business.netlify.app/)
